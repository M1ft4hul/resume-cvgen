...
class Genpublic extends BaseController
{
    public function index()
    {
        ...
        $this->Muser->save([
            'id' => $id,
            'id_genpublic' => 'genpublic'
        ]);
        return view('/genpublic/index');
    }
    public function pdf_view_genpublic()
    {
        ...
        return view('/genpublic/pdf_view', $data);
    }
    public function pdf_print_genpublic()
    {
        $biodata = $this->Muser->profil_user(session()->get('id'))->getRow();
        $keahlian = $this->Muser->keahlian_user(session()->get('id'))->getResult();
        $pengalaman = $this->Muser->pengalaman_user(session()->get('id'))->getResult();
        ...
        return view('/genpublic/pdf_print', $data);
    }
}
