...
class Cruise_ship extends BaseController
{
    public function index()
    {
        ...
        if ($biodata['tempat_lahir'] == "" || !$keahlian || !$pengalaman  || !$pendidikan) {
        ...
        $this->Muser->save([
            'id' => $id,
            'id_cruiseship' => 'cruiseship'
        ]);

        return view('/cruise_ship/index');
    }
    public function pdf_view_cruiseship()
    {
        $biodata = $this->Muser->profil_user(session()->get('id'))->getRow();
        $keahlian = $this->Muser->keahlian_user(session()->get('id'))->getResult();
        ...
        return view('/cruise_ship/pdf_view', $data);
    }
    public function pdf_print_cruiseship()
    {
        $biodata = $this->Muser->profil_user(session()->get('id'))->getRow();
        $keahlian = $this->Muser->keahlian_user(session()->get('id'))->getResult();
        $pengalaman = $this->Muser->pengalaman_user(session()->get('id'))->getResult();
        ...
        return view('/cruise_ship/pdf_print', $data);
    }
}
