                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    ...
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                                        <p class="text-white">Don't have an account yet?<br><a role="button" tabindex="0" href="/daftar" class="mt-2 px-4 btn btn-outline-light">Sign Up</a></p>
                                    ...
                                    <div class="p-4 p-md-4 flex-grow-1">
                                        ...
                                        <form action="/cek_login" method="post">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input class="form-control <?= ($validation->hasError('username')) ? 'is-invalid'  : ''; ?>" id="card-username" type="text" name="username" autocomplete="off" />
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input class="form-control <?= ($validation->hasError('password')) ? 'is-invalid'  : ''; ?>" id="password" type="password" name="password" autocapitalize="off" />
                                            ...
                                            <div class="row flex-between-center">
                                                <div class="col-auto">
                                                    <a class="fs--1" href="lupa">Forgot the password?</a>
                                                </div>
                                            </div>
                                            <div class="mb-2">
                                                <button class="btn btn-success d-block w-100 mt-3" type="submit" onclick="loading()">Login</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
