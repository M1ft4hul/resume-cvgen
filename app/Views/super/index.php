                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body"><?= $deckengine ?> Deck Engine</div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-warning text-white mb-4">
                                <div class="card-body"><?= $cruiseship ?> Hotel Dept.</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="#">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-success text-white mb-4">
                                <div class="card-body"><?= $lebenslauf ?> Lebenslauf</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="#">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-danger text-white mb-4">
                                <div class="card-body"><?= $publickuse ?> Public Use</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="#">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            ...
                            <table id="datatablesSimple">
                                <thead>
                                    <tr>
                                        <th>Nama</th>
                                        <th>Deck Engine</th>
                                        <th>Hotel Dept. for Cruise Ship</th>
                                        <th>Lebenslauf</th>
                                        <th>Public Use</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($kandidat as $a) : ?>
                                        <tr>
                                            <td>
                                                <?= $a->nama ?>
                                                <p><a href="https://wa.me/+62<?= $a->wa ?>?text=Hi%20<?= $a->nama ?>,..." class="btn btn-success "><i class="bi bi-whatsapp"></i></a></p>
                                            </td>
                                            <td><?= $a->id_deckengine ?></td>
                                            <td><?= $a->id_cruiseship ?></td>
                                            <td><?= $a->id_lebenslauf ?></td>
                                            <td><?= $a->id_publickuse ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
