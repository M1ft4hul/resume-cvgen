...
<body>
    ...
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" method="POST" action="/reset_password/<?= $token ?>">
            <div class="form-field d-flex align-items-center">
                <span class="fas fa-key"></span>
                <input type="password" name="pwd" id="pwd" placeholder="*****" class="form-control <?= ($validation->hasError('pwd')) ? 'is-invalid' : ''; ?>" value="<?= old('pwd'); ?>" autocomplete="off">
            ...
            <div class="form-field d-flex align-items-center">
                <span class="fas fa-key"></span>
                <input type="password" name="cpwd" id="cpwd" placeholder="******" class="form-control <?= ($validation->hasError('cpwd')) ? 'is-invalid' : ''; ?>" value="<?= old('cpwd'); ?>" autocomplete="off">
                <div class="invalid-feedback">
                    <?= $validation->getError('cpwd'); ?>
                </div>
            </div>
            <button class="btn mt-3">Reset Password</button>
        </form>
        <div class="text-center"><small>Already have an account?</small> - <a href="/login">Sign in</a> </div>
    </div>
