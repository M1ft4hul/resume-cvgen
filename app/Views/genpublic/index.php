                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item text-center p-3">
                            <div class="btn-group w-100  " role="group" aria-label="Basic example">
                                <button type="button" class="shadow-sm p-2  btn btn-warning btn-lg " onclick="document.getElementById('frame_genpublic').contentWindow.download();"><i class="bi bi-cloud-download-fill"></i> SAVE PDF <small>(Default Size)</small></button>
                                <button type="button" class="shadow-sm p-2  btn btn-danger btn-lg" onclick="document.getElementById('frame_genpublic').contentWindow.print();"><i class="bi bi-printer-fill"></i> PRINT/SAVE <small>(Custom Size)</small> </button>
                            </div>
                        </li>
                        <li class="list-group-item text-center">
                            <div class="ratio ratio-1x1">
                                <iframe class="embed-responsive-item" name="frame" src="<?= base_url('/pdf_view_genpublic') ?>"></iframe>
                            </div>

                            <iframe class="embed-responsive-item" width="0px" height="0px" name="frame_genpublic" id="frame_genpublic" src="<?= base_url('/pdf_print_genpublic') ?>"></iframe>
