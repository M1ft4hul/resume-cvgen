                ...
                <div class="col-lg-9 ">
                    <div class="card shadow-sm">
                        <div class="card-body shadow-sm">
                            ...
                            <p class="card-text"><?= nl2br($lowongan->deskripsi_lowongan) ?></p>
                            <h6 class="card-subtitle text-muted mt-2">Detail</h6>
                            <p class="card-text mb-0">Pendaftaran: <?= date('d-M', strtotime($lowongan->dibuka_lowongan)) ?> s/d <?= date('d-M-Y', strtotime($lowongan->ditutup_lowongan)) ?></p>
                            <p class="card-text mb-0">Kuota : <?= $lowongan->kuota_lowongan ?> Kandindat</p>
                            <p class="card-text">Negara: <?= $lowongan->negara_lowongan ?></p>
                            <div class="d-block d-lg-none d-xl-none">
                                <div class="btn-group w-100" role="group" aria-label="Basic mixed styles example">
                                    <a href="<?= base_url('/gform') ?>" class="btn btn-secondary px-3 ">
                                        < Back</a>
                                            <a href="whatsapp://send?text=Hi Admin, could you please explain in more detail about this <?= $lowongan->nama_lowongan ?>?&phone=+62<?= $lowongan->kontak_admin ?>&abid=+62<?= $lowongan->kontak_admin ?>" class="btn btn-primary px-3 ">Apply</a>
                                </div>
