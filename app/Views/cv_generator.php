        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="col-lg-9 mb-5">
                    <ul class="list-group">
                        <li class="list-group-item active" aria-current="true">CV-Generator</li>
                                ...
                                <div class="col">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-footer p-1">
                                            <a href="/deck_engine" class="btn btn-primary w-100">Cek Detail</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-footer p-1">
                                            <a href="/cruise_ship" class="btn btn-primary w-100">Cek Detail</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-footer p-1">
                                            <a href="/lebenslauf" class="btn btn-primary w-100">Cek Detail</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-footer p-1">
                                            <a href="/genpublic" class="btn btn-primary w-100">Cek Detail</a>
                                        </div>
                                    </div>
                                </div>
