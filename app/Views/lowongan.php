        ...
        <div class="container ">
            <div class="row">
                                ...
                                <div class="accordion-body">
                                    <ul class="list-group">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <a href="/login">
                                                <li class="list-group-item">Looking for Candidate</li>
                                            </a>
                                            <a href="/gform">
                                                <li class="list-group-item">Job Vacancy</li>
                                            </a>
                ...
                <div class="col-lg-9 mb-5">
                    <ul class="list-group">
                        <li class="list-group-item active" aria-current="true">CHOOSE CURRICULUM VITAE</li>
                        <li class="list-group-item">
                            <p>Welcome, <br>Choose the type of Job, and create your Curriculum Vitae.</p>
                            <hr>
                                ...
                                <div class="col">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body text-center">
                                            <div class="card-title fw-bold text-center">CV for Seafarer<br>(Deck Engine) </div>
                                            <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, labore. Quae, et..</p>

                                        </div>
                                        <div class="card-footer p-1">
                                            <a href="/deck_engine" class="btn btn-primary w-100">Create</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body text-center">
                                            <div class="card-title fw-bold ">CV for Seafarer<br>(Hotel Dept. for Cruise Ship) </div>
                                            <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, labore. Quae, et..</p>

                                        </div>
                                        <div class="card-footer p-1">
                                            <a href="/cruise_ship" class="btn btn-primary w-100">Create</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body text-center">
                                            <div class="card-title fw-bold ">CV for Working in Germany<br>(Lebenslauf) </div>
                                            <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, labore. Quae, et..</p>

                                        </div>
                                        <div class="card-footer p-1">
                                            <a href="/lebenslauf" class="btn btn-primary w-100">Create</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body text-center">
                                            <div class="card-title fw-bold ">CV format in General<br>(Public Use)</div>
                                            <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, labore. Quae, et..</p>

                                        </div>
                                        <div class="card-footer p-1">
                                            <a href="/genpublic" class="btn btn-primary w-100">Create</a>
                                        </div>
                                    </div>
                                </div>
